...
import 'package:widgetbook_workspace/components/sidebar/linagora_sidebar_version_use_case.dart';
      ...
      directories: [
        ...
        WidgetbookFolder(
          ...
          children: [
            ...
            WidgetbookComponent(
              name: 'Linagora sidebar version',
              useCases: [
                WidgetbookUseCase(
                  name: 'Default',
                  builder: (context) => linagoraSidebarVersionUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
              name: 'Linagora sidebar section header',
              useCases: [
                WidgetbookUseCase(
                  name: 'Default',
                  builder: (context) =>
                      linagoraSidebarSectionHeaderUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
            ...
            WidgetbookComponent(
              name: 'Linagora sidebar grouped tree list',
              useCases: [
                WidgetbookUseCase(
                  name: 'Grouped virtualized folder trees',
                  builder: (context) =>
                      linagoraSidebarGroupedTreeListUseCase(context),
                ),
              ],
            ),
            WidgetbookComponent(
