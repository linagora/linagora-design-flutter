...
abstract final class LinagoraEventInfoColors {
  ...
  /// Disabled inline actions.
  static const Color disabledAction = LinagoraButton.disabledContentColor;
}
...
class LinagoraEventInfoLink extends StatelessWidget {
  ...
  /// Label and icon colour while disabled.
  ...
  const LinagoraEventInfoLink({
    ...
    this.disabledColor = LinagoraEventInfoColors.disabledAction,
    this.textStyle,
    this.tooltip,
  }) : assert(
         iconSpacing >= 0 && iconSpacing < double.infinity,
         'Icon spacing must be finite and non-negative',
       );
