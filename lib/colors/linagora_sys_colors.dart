...
class LinagoraSysColors {
  ...
  final Color? _textSecondaryDark;

  Color get onTextSecondaryDark => _textSecondaryDark ?? textSecondary;
  ...
  LinagoraSysColors({
    ...
    onTextSecondaryDark,
       ...
       _textSecondaryDark = onTextSecondaryDark;
  ...
  LinagoraSysColors._material()
    : primary = const Color(0xFF0A84FF),
      ...
      textSecondary = const Color(0xFF5C6268),
